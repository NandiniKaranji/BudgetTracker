...
function CurrentPrice() {
  ...
  const getChartDetails = (selectCoins = {}) => {
    CurrentPriceService.getSelectedCoinLineChart(
      selectFilterOption,
      selectCoins
    )
      .then((response) => {
  ...
  const onChangeBitCoin = (e) => {
    ...
    getChartDetails(allBitCoinsDetails.bpi[value]);
  };
      ...
      <section className="coin__info">
        <div className="coin-info__list">
          ...
          <div className="coin-info-value">
            <span>{getCoinSymbol(selectedCoin?.value)}</span>
